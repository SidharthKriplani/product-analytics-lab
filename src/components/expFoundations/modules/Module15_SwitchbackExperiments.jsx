  ...
  var questions = [
    {
      ...
      options: [
        { label: 'A. The experiment simply runs too slowly to collect enough statistically significant data before any hard deadline arrives', correct: false },
        ...
        { label: 'C. Control group drivers cannot be identified because they all use the exact same dispatch app interface', correct: false },
        { label: 'D. Geo experiment power is too low for city-level randomization given how few cities are available', correct: false },
      ],
    ...
    },
    {
      ...
      options: [
        { label: 'A. The sample size is smaller because there are only a handful of two-hour time periods available per day, not per city', correct: false },
        ...
        { label: 'C. Geographic confounds become impossible to control for once you stop randomizing by city and switch entirely to a time-based design instead', correct: false },
        { label: 'D. Drivers remember which arm the previous window was in and deliberately change their behavior once control begins', correct: false },
      ],
    ...
    },
    {
      ...
      options: [
        { label: "A. Testing a new onboarding flow for a SaaS product where every user's experience is fully independent of other users", correct: false },
        { label: 'B. Testing a TV advertising campaign that ran in a handful of pre-selected metro markets last quarter', correct: false },
        { label: 'C. Testing a surge pricing algorithm for a ride-sharing platform operating in a single dense market', correct: true },

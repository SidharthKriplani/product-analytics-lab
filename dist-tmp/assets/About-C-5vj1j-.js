import{mt as e}from"./index-By1M1jPs.js";var t=e();function n(){return(0,t.jsxs)(`div`,{className:`pal-page-enter`,style:{maxWidth:`760px`,margin:`0 auto`,padding:`2.5rem 1.5rem`},children:[(0,t.jsxs)(`div`,{style:{marginBottom:`2.5rem`},children:[(0,t.jsx)(`h1`,{style:{fontSize:`1.6rem`,fontWeight:800,color:`var(--text)`,letterSpacing:`-0.025em`,marginBottom:`0.4rem`},children:`About PAL`}),(0,t.jsx)(`p`,{style:{color:`var(--text-muted)`,fontSize:`0.875rem`,margin:0},children:`What it is, how it works, and how to get value from it.`})]}),[{title:`What this is`,body:`Product Analytics Lab (PAL) is an interactive judgment gym for product analysts, data analysts, and PMs who want to practice the analytical decisions that decide real interviews — not recall frameworks from a textbook.
...
17 rooms. 150+ cases. SQL Lab with 130 problems. Foundation modules across Stats, Experimentation, RCA, and Metrics. Every case tests judgment, not recall.`},{title:`Who it's for`,body:`Product analysts, data analysts, business analysts, and PMs preparing for senior IC and leadership-track interviews.
...
If you already know what a p-value, SRM, and metric tree are — jump directly into the practice rooms and use Defense Strategy to build a targeted prep plan from your actual job description.`},{title:`How it differs from DataLemur, StrataScratch, Exponent`,body:`DataLemur and StrataScratch: excellent SQL and Python question banks. PAL is not a question bank — it is a judgment system. The cases are not "write a query that returns X." They are "here is a metric that dropped 18% — what do you check first and why?"
...
The specific gap PAL targets: experiment analysis judgment (not just stats formulas), RCA diagnostic instinct (not just framework recitation), and metric design under business pressure (not just definitions). These are the skills that decide senior PA interviews that existing tools do not systematically practice.`},{title:`How to use PAL`,body:`New to product analytics or transitioning from another field:
...
Tracking progress:
→ Progress page shows completion by room, role readiness score, a practice heatmap, and recommended next steps.`},{title:`The rooms`,body:`Foundation rooms (free, start here if new):
...
— Deep Dives: long-form Playbook articles on every major concept`},{title:`Difficulty levels`,body:`Every case and problem in PAL is tagged with a difficulty level:
...
Filter by difficulty in any room browser using the chips above the case list.`},{title:`Technical details`,body:`Fully static React + Vite SPA. No backend, no database, no API calls. All case content ships as JavaScript data files. Progress is stored in your browser's localStorage. Nothing leaves your device.
...
Deployed on Vercel. Works offline once loaded. Free to use with access code; full access via one-time unlock.`}].map((e,n)=>(0,t.jsxs)(`div`,{style:{marginBottom:`2rem`},children:[(0,t.jsx)(`h2`,{style:{fontSize:`0.95rem`,fontWeight:700,color:`var(--text)`,marginBottom:`0.65rem`,paddingBottom:`0.5rem`,borderBottom:`1px solid var(--border)`},children:e.title}),(0,t.jsx)(`div`,{style:{fontSize:`0.875rem`,color:`var(--text-secondary)`,lineHeight:1.75,whiteSpace:`pre-line`},children:e.body})]},n))]})}export{n as About};